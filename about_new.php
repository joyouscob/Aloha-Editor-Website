...
<? include('inc/menu.inc'); ?>
		...
		<div id="teaser" class="container_20">
			<div class="grid_14">
				...
				<a href='https://developer.mozilla.org/en/JavaScript/Guide' title='JS Tutorial' style="float:left;padding:15px 25px 5px 0; border:none"><img src='http://static.jsconf.us/promotejsv.gif' height='200' alt='JS Tutorial'/></a>
				...
				<img src="logo/Aloha%20Editor%20HTML5%20contenteditable%20transparent%20256.png" style="float:left;padding:25px 25px 5px 0; "><p>Aloha Editor works perfectly in all current browsers and websites using HTML4! It is the HTML5 Editor because it <a href="https://github.com/alohaeditor/Aloha-Editor/blob/master/WebContent/utils/dom.js#L56">implements all functionality</a>
				respecting with no compromise the <a href="http://www.whatwg.org/specs/web-apps/current-work/">HTML5 specification</a>. It aims to generate <b>full 
				compliant xHTML5 content</b>, but you don't need to use HTML5 specific methods, if you don't want to. The Aloha Editor uses and extends the attribute
				...
				<img src="images/aloha-editor-logo.png" alt="Home" style="float:right;width:150px;padding-right:25px"/>
